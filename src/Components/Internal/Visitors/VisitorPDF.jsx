                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.info_two_column}>
                            ...
                            <Text style={styles.info_two_column_right}>{visitor.schoolname}</Text>
                        </View>
                        <View style={styles.info_two_column}>
                        ...
                        <View style={styles.info_two_column_last}>
                            ...
                            <Text style={styles.info_two_column_right}>{visitor.country_name}</Text>
                        </View>
                    </View>
                </View>
            </Page>
