...
function SMS({ history }) {
    ...
    useEffect(() => {
        document.title = 'RiiVe Admin | SMS';
    ...
    const onSubmit       = (action) => {
        ...
        if(action.toLowerCase() === 'yes') {
            ...
            const data       = {
                ...
                school_id    : user && user.access_level.toLowerCase() === 'administrator'  ? user.id : user.school_id,
                teacher_id   : user && user.access_level.toLowerCase() === 'sub admin' ? user.id : '',
